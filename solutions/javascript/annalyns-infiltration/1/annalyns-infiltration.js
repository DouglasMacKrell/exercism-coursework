...
export function canFreePrisoner(
  ...
  if (!archerIsAwake) {
    ...
    else if (prisonerIsAwake && knightIsAwake && !petDogIsPresent) return false;
    else if (!petDogIsPresent && prisonerIsAwake) return true;
    else if (prisonerIsAwake && petDogIsPresent && !knightIsAwake) return true;
    else if (prisonerIsAwake && petDogIsPresent && knightIsAwake) return true;
  };
  return false;
}
